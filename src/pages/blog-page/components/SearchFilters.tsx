    ...
    <div className="py-4 sm:py-6">
      <div className="mx-auto">
        ...
        <div className="flex items-center mb-4 sm:mb-6">
          <button className="flex bg-[#1C1D21] py-3 sm:py-4 lg:py-5 px-4 sm:px-8 lg:px-20 w-full items-center justify-center sm:justify-start text-gray-300 hover:text-white transition-colors">
        ...
        {/* Search and Filters */}
        <div className="px-3 sm:px-6 md:px-12 lg:px-8">
