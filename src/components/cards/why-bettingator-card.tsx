export function WhyBettingatorCard({
  ...
  return (
    <div className="w-full p-[1px] rounded-[12px] bg-gradient-to-b from-[#61F308BF] to-[#15B54BBF] max-w-[304px] min-h-[248px] self-stretch">
...
export function WhyBettingatorCardSmall({
  ...
  return (
    <div className="w-full p-[1px] rounded-[12px] bg-gradient-to-b from-[#61F308BF] to-[#15B54BBF] max-w-[384px] min-h-[116px] self-stretch">
      <div className="w-full h-full rounded-[11px] bg-[#1A1B1E] text-white flex flex-col overflow-clip py-5 px-7 gap-5">
        {/* content actualtity start */}
