  ...
  return (
    <div className="w-full mt-[72px] px-4 sm:px-8">
      <div className="bg-[#1C1D2199] flex flex-col sm:flex-row items-center sm:items-start justify-between rounded-[16px] p-6 sm:p-0">
        {/* Text Content */}
        <div className="flex flex-col sm:pt-8 sm:pl-14 text-center sm:text-left w-full sm:w-auto">
        ...
        {/* Button */}
        <div className="w-full sm:w-auto flex justify-center sm:justify-end sm:mr-10">
          <GradientBackgroundButton className="h-[48px] w-full sm:w-[194px] mt-2">
            Apply Now
